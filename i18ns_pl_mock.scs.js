...
export default class I18n {
  ...
  //@todo Очень очень отдалённое %Функционал% Возможно, нужно смотреть состав параметров и если параметр объект (или пусть он первым будет? или пусть поименованным будет), - то воспринимать его как добавку к params (сейчас мы всё воспринимаем как добавку)
